...
const CurriculumScreen = () => {
  ...
  const add=async(e)=>{ e.preventDefault(); const resp=await fetch('/api/curricula/',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({name})}); if(resp.ok){ setList(l=>[...l,await resp.json()]); setName(''); } };
  return (
    <div>
      <h3>Curricula</h3>
